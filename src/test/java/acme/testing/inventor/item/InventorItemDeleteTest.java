...
public class InventorItemDeleteTest extends TestHarness {
	...
	@ParameterizedTest
	@CsvFileSource(resources = "/inventor/item/deleteTool.csv", encoding = "utf-8", numLinesToSkip = 1)
	@Order(10)
	...
	@ParameterizedTest
	@CsvFileSource(resources = "/inventor/item/negativeDeleteTool.csv", encoding = "utf-8", numLinesToSkip = 1)
	@Order(10)
